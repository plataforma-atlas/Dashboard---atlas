  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-[13px]">
        <thead>
          <tr>
            <th className="text-left text-[11px] uppercase tracking-[0.05em] text-[var(--wos-ink-muted)] font-normal py-2.5 px-2">Campaña</th>
            <th className="text-right text-[11px] uppercase tracking-[0.05em] text-[var(--wos-ink-muted)] font-normal py-2.5 px-2">Ventas</th>
            <th className="text-right text-[11px] uppercase tracking-[0.05em] text-[var(--wos-ink-muted)] font-normal py-2.5 px-2">Facturación</th>
            <th className="text-right text-[11px] uppercase tracking-[0.05em] text-[var(--wos-ink-muted)] font-normal py-2.5 px-2">ROAS</th>
            <th className="text-right text-[11px] uppercase tracking-[0.05em] text-[var(--wos-ink-muted)] font-normal py-2.5 px-2">Estado</th>
          </tr>
        </thead>
        <tbody>
          {ordenadas.map((c) => (
            <tr key={c.campaign_id} className="border-t border-[var(--wos-border)]">
              <td className="py-3.5 px-2">
                ...
                <div className="text-[11px] text-[var(--wos-ink-muted)] mt-0.5">{formatNumber(c.registros)} registros</div>
              </td>
              ...
              <td className="py-3.5 px-2 text-right">
                <span className={`inline-block text-[11px] font-semibold uppercase tracking-[0.04em] rounded-full px-2.5 py-1 border whitespace-nowrap ${estadoBadgeClass(c.estado)}`}>
                  {c.estado}
                </span>
              </td>
            </tr>
