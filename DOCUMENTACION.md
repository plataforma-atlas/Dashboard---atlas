...
- `encuesta` y `gracias` **no se tocaron en esta pasada** — siguen con el diseño simple de card centrada de la primera versión (sección 21, "El generador de HTML propio"). El usuario pidió explícitamente enfocarse en "Captura" primero.
